...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Stratix II" INIT_FILE="rom_memory" NUMWORDS_A=128 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK1" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=7 address_a clock0 clock1 q_a
...
module  lpm_rom_for_lab3_altsyncram
	( 
	address_a,
	clock0,
	clock1,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_1.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_2.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_3.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_4.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_5.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_6.init_file = "rom_memory",
	...
	defparam
		...
		ram_block1a_7.init_file = "rom_memory",
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file rom_memory is not found. This may result in inconsistent simulation results.");
	end
endmodule //lpm_rom_for_lab3_altsyncram
//VALID FILE
...
module lpm_rom_for_lab3 (
	...
	lpm_rom_for_lab3_altsyncram	lpm_rom_for_lab3_altsyncram_component (
				.clock0 (inclock),
				.clock1 (outclock),
				.address_a (address),
				.q_a (sub_wire0));
...
// Retrieval info: PRIVATE: MIFfilename STRING "rom_memory"
...
// Retrieval info: CONSTANT: INIT_FILE STRING "rom_memory"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3.bsf TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3_inst.tdf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3_waveforms.html TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3_wave*.jpg FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_rom_for_lab3_syn.v TRUE
